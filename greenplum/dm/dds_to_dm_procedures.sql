-- Процедуры для вставки данных из DDS в DM
begin transaction;
--------------------------------------------------------------------------------------------
-- 1. Вставка данных в таблицу с информацией об активностях клиентов
--------------------------------------------------------------------------------------------
...
BEGIN
    ...
    TRUNCATE TABLE dm.clients_activity_logins_e_krylova;
...
;
--------------------------------------------------------------------------------------------
-- 2. Вставка данных в таблицу с информацией о клиентах и их транзакциях
--------------------------------------------------------------------------------------------
...
BEGIN
    -- Удаление существующих данных из таблицы 
    TRUNCATE TABLE dm.transactions_e_krylova;
...
;
--------------------------------------------------------------------------------------------
-- 3. Вставка данных в таблицу с информацией о клиентах и их платежах
--------------------------------------------------------------------------------------------
...
BEGIN
    -- Удаление существующих данных из таблицы 
    TRUNCATE TABLE dm.payments_e_krylova;
...
-- 4. Вызовы процедур
--------------------------------------------------------------------------------------------
call dm.load_clients_activity_e_krylova();
call dm.load_transactions_e_krylova();
call dm.load_payments_e_krylova();

-- Проверка
select * from dm.clients_activity_logins_e_krylova limit 20;
select * from dm.transactions_e_krylova limit 20;
select * from dm.payments_e_krylova limit 20;
